...
Today, we have two-fold goal. We want to get a general historical overview of what is happening in the Roman Empire in the 4th and 5th centuries. And the same time we want to see these developments from the specific perspective of someone who lived through these changes. This person was, of course, Augustine. 

Augustine's perspective is important, not only because he is a primary witness, because he was an attempting to explain and provide meaning for events. Further, Augustine is so influential on the culture and ideas of the coming Middle Ages, that we need to see in his ideas the slow development of particular world view that will come to permeate much of European life in the following centuries.

# Some Historical Background 

Using our text, *A Short History of the Middle Ages* (SHMA) by Roswein consider (and using the annotation tool) offer some answers to the following questions.

{:.dquestion}
What was the crises of the third century?
...
{:.dquestion}
Question: What are some of the most important/influential reforms that Diocletian instituted?
...
This was the Diocletian also initiated a period of persecution against the rising Christian sect. And it played a role in one of the first schisms between the church, particularly relevant to Augustine's life and work. 
...
Upon the end of the persecution under, those who went underground, re-surfaced. Those who had faced the persecution head on, called the Donatists, somewhat justiably, felt that this previously members were apostate because of their cowardess, and should not be considered members of the church.

Much of Augustine writing has to do with, reconciling the two parties and unifying a catholic church. (or universal) church.
</div>

Here are some other events that occur in the 4th and 5th century which are fairly critical for understanding what Augustine is up to in the city of God.

* 303 persecutory edict in 303 (Diocletian)
  * Diocletian initiates persecution of Christians (as scape goat and cause of 3rd century decline )
* 311 Edict of Serdica (Sofia, Bulgaria) (edict of toleration) 
  * Galerius rescinds the persecution against the Christians
* 313 Edict of Milan (under emperor Constantine) 
  * Constantine re-asserts the toleration of Christians  
* 380 The edict of Thessalonica declares Christianity as a state religion. 
* 410 Alaric and the visigoths sack Rome, a the very least a symbolic form of Rome's glory and power 

<div class="discussion" markdown="1">
Before reading further

{:.question}
Can you think of any reasons why the steady rise in the fortune of Christians in the 4th century and the successful attack of Alaric in 410 poses problems for a Christian like Augustine? 

{:.answer}
On the assumption that divine favor and worldly success/happiness are linked, the setback for Rome suggest that the rise of Christianity has not been a good thing and could even be considered the "cause" of Rome's decline. 

{:.question}
How is this problem motivating Augustine in the *City of God*?

{:.answer}
Augustine is trying to offer a defense of the Christian's against these accusations.
</div>

# The Accusation Augustine Faces

As noted above, all of these events lead us to a narrative or accusation that is the central focus of our reading. 
...
Augustine's *City of God*, whose full title, is *City of God, against the Pagans*, is therefore a kind of Apology (a "defense"). It was begun after the sack of Rome in 410 and was something he worked on for much of the rest of his life. 

Our reading today is on chapter 2

I see this chapter, in general, as a fantastic encapsulation of Augustine's answer (or better, answer**s**) to these charges. Basically, it is his response to the accusation of the Pagans against the Christians. 
...
{:.question}
What kind of beliefs are already assumed an assessment about rise or decline? What beliefs have to be in place before you can decide if something is rising or declining?
...
Augustine recognizes precisely that there must already be a concept of what it means to be doing well. 
...
{:.rquestion}
Can we find some places where Augustine identifies conceptions of flourishing held be the Romans? (Look especially at chapter 20)

{:.rquestion}
What conception of success/happiness is described in chapter 20.

{:.dquestion}
Is this conception of happiness relatable?
...
{:.dquestion}
Why does Augustine reject this as genuine definition?
...
From Augustine's Christian point of view, how could this republic every people a true city on this definition -- a city permeated by true virtue -- if it wasn't under the Lordship of Christ. 
...
So, at this point, I would like to step and back a little and think about this definition of the city that Cicero and provides and to which Augustine's response.
...
**example 1**
What about criminal justice or the prison system? Is it possible to have city without a criminal justice system? Maybe in a perfect world, but what about in our world, where crimes are committed, etc. 
...
This is the Cicero/Scipio view. It is not really a city unless it ruled by justice. And the false city (or the "unjust law") doesn't have any authority us. We should do whatever we need to reject and oppose the false city in order to establish the just city (or the just law)
...
But can an action ever be so pure? Is there way, his pursuit of justice, could be at the same time perpetuating new injustices? 
...
Because of this ambiguity, neither the Roman republic nor a Christian empire will ever meet Cicero's definition of truly just city.
...
Augustine (along with Pilus) is putting forward what is sometimes called a "political realist" position (which you might also see in modern theorists like Thomas Hobbes or Reinhold Niebuhr), as opposed to a much more classical "political idealism" that you might seen in Aristotle or Cicero. 
